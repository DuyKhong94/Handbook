    ...
    with st.container():
        ...
        if uploaded_file is not None:
            ...
            df_filtered_by_date=df_filtered_by_date[df_filtered_by_date['TTI Model No'].str.startswith(('030','106','001597','001606','001514','001406','011196','130514','130606','130597','130690'),na=False)
                                & df_filtered_by_date['Job No'].str.startswith(('001','030','QB','PR','MP','EB','ESB','106','054','056','159196'), na=False)
                                ]
            ...
            st.markdown(f"**Tổng số line trong ngày: {total_line}**")
            st.markdown(f"**Tổng số changeover trong ngày: {int(total_changeover)}**")
            st.divider()
