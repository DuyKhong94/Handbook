...
# # ==========================================================
   ...
   #body of email
    ...
    axs[0,1].legend(df_pie["Area"],loc='lower right',bbox_to_anchor=(1.65, 0),title="Dollars Cont.")
    ...
    pcba=len(df7["Material Category"]=="PCBA")
    switch=len(df7["Material Category"]=="Switch")
